...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: Cloneforce): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: Cloneforce): Logger {
