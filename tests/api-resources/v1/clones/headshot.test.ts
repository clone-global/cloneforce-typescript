...
describe('resource headshot', () => {
  // Mock server tests are disabled
  test.skip('generate', async () => {
    const responsePromise = client.v1.clones.headshot.generate('cloneId');
  ...
  test.skip('generate: request options and params are passed correctly', async () => {
    ...
    await expect(client.v1.clones.headshot.generate('cloneId', { additionalInstructions: 'additionalInstructions' }, { path: '/_stainless_unknown_path' }))
      .rejects
