...
describe('resource gallery', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.v1.clones.gallery.create('cloneId', { mediaUrl: 'mediaUrl', type: 'Video' });
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.v1.clones.gallery.list('cloneId', { type: 'Video' }, { path: '/_stainless_unknown_path' }))
      .rejects
